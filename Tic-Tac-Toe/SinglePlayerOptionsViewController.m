//
//  SinglePlayerOptionsViewController.m
//  Tic-Tac-Toe
//
...
@interface SinglePlayerOptionsViewController ()

@end

@implementation SinglePlayerOptionsViewController
...
{
  [computerLabel resignFirstResponder];
}

-(IBAction) easyHardSelect:(id)sender
{
  if(sender == easyButton)
  {
    easyHardSelect = @"easy";
    easyButton.backgroundColor = selectedBlue;
    hardButton.backgroundColor = [UIColor lightGrayColor];
  }
  else if(sender == hardButton)
  {
    easyHardSelect = @"hard";
    easyButton.backgroundColor = [UIColor lightGrayColor];
    hardButton.backgroundColor = selectedBlue;
  }
}
...
-(IBAction) startGame
{
  if(((![easyHardSelect isEqualToString:@"easy"]) && (![easyHardSelect isEqualToString:@"hard"])) || ((![p1XOSelect isEqualToString:@"p1X"]) && (![p1XOSelect isEqualToString:@"p1O"])) || ((![firstXOXOSelect isEqualToString:@"x"]) && (![firstXOXOSelect isEqualToString:@"o"]) && (![firstXOXOSelect isEqualToString:@"xo"])))
  {
...
{
  [[NSUserDefaults standardUserDefaults] setBool:(BOOL)false forKey:@"coOpThisGame"];
  
  if([easyHardSelect isEqualToString:@"hard"])
  {[[NSUserDefaults standardUserDefaults] setBool:(BOOL)false forKey:@"easyThisGame"]; [[NSUserDefaults standardUserDefaults] setObject:@"hard" forKey:@"difficulty"];}
  else
  {[[NSUserDefaults standardUserDefaults] setBool:(BOOL)true forKey:@"easyThisGame"]; [[NSUserDefaults standardUserDefaults] setObject:@"easy" forKey:@"difficulty"];}
  ...
  [[NSUserDefaults standardUserDefaults] setObject:(computerLabel.text) forKey:@"player2Name"];
...
{
  if([[[NSUserDefaults standardUserDefaults] objectForKey:@"difficulty"] isEqualToString:@"easy"])
  {easyButton.backgroundColor = selectedBlue; easyHardSelect  = @"easy";}
  else if([[[NSUserDefaults standardUserDefaults] objectForKey:@"difficulty"] isEqualToString:@"hard"])
  {hardButton.backgroundColor = selectedBlue; easyHardSelect  = @"hard";}
